...
export default function App() {
  ...
  const getEducationHelp = async () => {
    ...
    const response = await axios.get('http://hopeconnect.somee.com/api/Education/GetAllEducation', {
      headers: {
          ...
          <Card style={styles.cardBox} key={index}>
            ...
            <Card.Content>
              <Text variant="titleLarge" style={styles.txt} key={index}>
                {educationItem.title}   __________________________________
              </Text>
            </Card.Content>
            <Text variant="bodyMedium" style={styles.txtdetail} >Name: {educationItem.name} </Text>
            <Text variant="bodyMedium" style={styles.txtdetail} >Location: {educationItem.location}</Text>
